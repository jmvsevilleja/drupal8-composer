...
namespace Drupal\Tests\drupal8_profile\Functional;
...
/**
 * Tests drupal8_profile profile.
 *
 * @group drupal8_profile
 */
class DemoUmamiProfileTest extends BrowserTestBase {
   ...
   * {@inheritdoc}
   */
  protected $profile = 'drupal8_profile';

  /**
   * Tests drupal8_profile profile warnings shown on Status Page.
   */
  ...
  public function testConfig() {
    ...
    $default_config_storage = new FileStorage(drupal_get_path('profile', 'drupal8_profile') . '/' . InstallStorage::CONFIG_INSTALL_DIRECTORY, InstallStorage::DEFAULT_COLLECTION);
    $this->assertDefaultConfig($default_config_storage, $active_config_storage);

    $default_config_storage = new FileStorage(drupal_get_path('profile', 'drupal8_profile') . '/' . InstallStorage::CONFIG_OPTIONAL_DIRECTORY, InstallStorage::DEFAULT_COLLECTION);
    $this->assertDefaultConfig($default_config_storage, $active_config_storage);
  }
